...
const controlRecipe = async() => {
    ...
    // URL дээр id байгаа эсхийг шалгана
    if (id) {
...
window.addEventListener("load", (e) => {
    // Шинээр лайк моделийг аъъ ачаалагдахад үүсгэнэ.
    if (!state.likes) state.likes = new Like();
    // Лайк цэсийг гаргах эсэхийг шийдэх
    likesView.toggleLikeMenu(state.likes.getNumberOfLikes());

    // Лайкууд байвал тэдгээрийг цэсэнд харуулна.
...
const controlList = () => {
    ...
    state.list = new List();
    // Өмнө харагдаж байсан найрлагуудыг дэлгэцэнээс зайлуулна.
    listView.clearItems();
...
const controlLike = () => {
    ...
    // 2) Одоо харагдаж байгаа жорны ID-ийг олж авах
    const currentRecipeId = state.recipe.id;
    // 3) Энэ жорын лайкалсан эсэхийг шалгах
